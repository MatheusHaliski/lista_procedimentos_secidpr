...
export const CADERNOS: Caderno[] = [
  {
    ...
    descricao: 'Coletânea de boas práticas e lições aprendidas na gestão de convênios com municípios paranaenses.',
    area: 'Convênios',
    corCapa: '#003876',
    capitulos: [
      {
        ...
        blocos: [
          { tipo: 'caso_pratico', titulo: 'Caso Prático — Maringá 2024', conteudo: 'O município de Maringá reduziu em 40% o prazo de análise ao apresentar toda a documentação digitalizada e organizada conforme o checklist do sistema, evitando diligências posteriores.' },
    ...
    capitulos: [
      {
        ...
        blocos: [
          { tipo: 'erro_comum', titulo: 'Fotos sem georreferenciamento', conteudo: 'Fotografias sem data, hora e localização georreferenciada são frequentemente impugnadas nas auditorias do TCE-PR. Use sempre o GPS do smartphone ativado ao tirar fotos de obras.' },
      ...
      },
      {
        ...
        blocos: [
          { tipo: 'caso_pratico', titulo: 'Caso — Guarapuava 2023', conteudo: 'Fiscal aprovou estrutura de concreto sem exigir ensaio de resistência. Após conclusão da obra, laudo apontou resistência abaixo do especificado, gerando necessidade de reforço estrutural e impugnação parcial da prestação de contas.' },
        ],
      },
    ],
  },
  {
    ...
    capitulos: [
      ...
      },
      {
        ...
        blocos: [
          { tipo: 'referencia_legal', titulo: 'Legislação aplicável', conteudo: 'Lei Federal nº 10.257/2001 (Estatuto da Cidade), Lei Federal nº 6.766/1979 (parcelamento do solo urbano), Decreto Estadual nº 2.581/2004 (parcelamento do solo no Paraná).' },
        ],
      },
    ],
  },
  {
    ...
    titulo: 'Regularização fundiária — casos práticos do Paraná',
    descricao: 'Compilação de casos reais de regularização fundiária realizados em municípios paranaenses com aplicação da Lei nº 13.465/2017.',
    area: 'Habitação',
    corCapa: '#F5A623',
    capitulos: [
      {
        ...
        blocos: [
          { tipo: 'caso_pratico', titulo: 'REURB-S em Curitiba — Bairro Tatuquara', conteudo: 'Regularização de 450 famílias em área de 18 hectares. Processo concluído em 14 meses com emissão de CRF e registro em cartório. Destaque para a participação comunitária no processo de levantamento cadastral.' },
        ],
      },
    ],
  },
  {
    ...
    descricao: 'Guia de boas-vindas e orientação para servidores que ingressam na SECID-PR.',
    area: 'Administrativo',
    corCapa: '#0077C8',
    capitulos: [
      {
        id: 'c1', titulo: 'Bem-vindo à SECID-PR',
        conteudo: 'A Secretaria de Estado das Cidades do Paraná (SECID-PR) tem como missão promover o desenvolvimento urbano sustentável dos municípios paranaenses, por meio de políticas de habitação, saneamento, urbanismo e convênios para obras de infraestrutura.',
      },
      {
      ...
      },
      {
        ...
        conteudo: 'Principais sistemas utilizados: Portal SAP SECID (gestão por processos), SOLAR (controle financeiro estadual), BNAFAR (licitações e contratos), SICONV/Transferegov (convênios federais), GeoPortal PR (geoprocessamento).',
      },
    ],
  },
];
